...
root_dir = r"C:\Users\shifa\Downloads\Dataset_Celebrities\cropped"
...
history = model.fit(x_train, y_train, epochs=160, batch_size=128, validation_split=0.1)
...
plt.savefig(r"C:\Users\shifa\Downloads\Dataset_Celebrities\sample_accuracy_plot.png")
...
plt.savefig(r"C:\Users\shifa\Downloads\Dataset_Celebrities\sample_loss_plot.png")
